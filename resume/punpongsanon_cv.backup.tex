...
\location{September 2016 | Osaka, Japan}
System Innovation \\
Graduate School of Engineering Science \\
\sectionsep

\descript{M.Eng in Engineering}
\location{September 2013 | Osaka, Japan}
System Innovation \\
Graduate School of Engineering Science \\
\sectionsep

\subsection{King Mongkut's University of Technology Thonburi}
\descript{BS in Computer Science (1$^{st}$ class honor)}
\location{April 2010 |  Bangkok, Thailand}
Applied Computer Science and Multimedia \\
Industrials Engineering \\
\location{Major GPA: 3.63 / 4.0}
\sectionsep
